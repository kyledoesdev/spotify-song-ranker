        ...
        @auth
			<div
				...
				>
					...
					@endif
					<a href="{{ route('rank.index') }}?user={{ auth()->user()->name }}" class="flex items-center gap-2 w-full first-of-type:rounded-t-md last-of-type:rounded-b-md px-4 py-2.5 text-left text-sm hover:bg-gray-50 disabled:text-gray-500">
						Profile
					</a>
