...
@php
    $link = match (true) {
        isset($url) => $url,
        isset($artist) => "https://open.spotify.com/artist/{$artist}",
        isset($song) => "https://open.spotify.com/track/{$song}",
        isset($playlist) => "https://open.spotify.com/playlist/{$playlist}",
        isset($show) => "https://open.spotify.com/show/{$show}",
        default => null,
    };
@endphp
