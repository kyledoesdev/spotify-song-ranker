<div class="overflow-hidden relative w-full h-auto mx-auto p-4">    
    <div class="w-full overflow-hidden">
        <div class="flex" 
             style="animation: artistSlideLeft 14s linear infinite; width: {{ count($this->duplicatedArtists) * 144 }}px; will-change: transform;">
            @foreach($this->duplicatedArtists as $index => $artist)
